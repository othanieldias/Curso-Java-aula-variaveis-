...
public class HelloWord {
	public static void main(String[] args) {
		...
		// metodo é toda a lógica da programação
		

			
			// Variaveis - é onde eu armazeno valores
			...
			// FAÇA UM PROGRAMA QUE CALCULE A MEDIA DE UM ALUNO
			...
			System.out.println(" A media final do aluno "  +  aluno2  +" é: " + calculoNota);
